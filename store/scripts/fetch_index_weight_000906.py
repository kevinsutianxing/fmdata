#!/usr/bin/env python3
"""拉取中证800历史成分权重（完整 PIT），按半年分页。

镜像 fetch_index_weight_000300.py，仅 INDEX_CODE/输出路径不同。schema 与 000300
完全一致（index_code, con_code, trade_date, weight），下游消费者零改动。
...
OUT_CSV = os.path.expanduser("~/fmdata/store/market/index_weight_000906.csv")
